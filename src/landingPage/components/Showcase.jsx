    ...
    >
      ...
      <div className="flex w-3/4">
        <div className="grid grid-cols-1 gap-4 rounded-3xl bg-orange-100 p-8 shadow-md shadow-black/30 md:grid-cols-6">
          ...
          <div className="col-span-1 flex items-center justify-center md:col-span-4">
      ...
      <div className="my-8 flex w-3/4">
        <div className="flex w-full flex-col items-center justify-center gap-4 rounded-3xl  bg-orange-100 p-8 shadow-md shadow-black/30">
          <h1 className="my-8 text-2xl font-medium md:text-3xl">FEATURES</h1>
          <h2 className="mb-16 text-center text-5xl font-semibold leading-snug text-green-700 md:text-7xl">
            Experience a <br />
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col justify-between gap-8 md:flex-row ">
              <div className="items:start flex flex-col items-center justify-center gap-4 text-center md:items-start md:justify-center md:text-start">
                <h1 className="w-fit rounded-full border border-black px-24 py-2 text-2xl font-bold lg:text-3xl">
                  360°
                </h1>
                <h2 className="text-3xl leading-snug text-green-700 lg:text-4xl">
                  Accurate depiction of the actual location
                </h2>
                <h3 className="text-2xl leading-snug lg:text-3xl">
                  Explore the campus through accurate <b>360° images</b> with
                  built-in support for <b>gyro</b> and <b>VR</b>, available only
                  on <b>supported mobile devices.</b>
                </h3>
              </div>
              <img
                src="/assets/Landing Page/img1.png"
                className="aspect-square object-contain lg:aspect-auto"
                alt="img1"
              />
            </div>
