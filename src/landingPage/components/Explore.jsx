...
const Explore = () => {
  return (
    <div className="h-full w-full pb-8" id="Explore">
      ...
      <div className="mx-4 flex flex-col items-center justify-center gap-8 md:flex-row ">
        ...
        <div className="relative flex items-center justify-center text-center">
          <div className="absolute inset-0 flex flex-col items-center justify-center space-y-2 px-12">
            <p className="px-4 text-left text-sm font-normal italic text-white lg:text-base">
              <b>Adventura360°</b> is an interactive map and tour made by
              student researchers of BS Computer Science. <b>Adventura360° </b>
